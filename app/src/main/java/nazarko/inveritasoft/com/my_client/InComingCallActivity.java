...
import   nazarko.inveritasoft.com.my_client.R;
    ...
    private Emitter.Listener onAnswerCall = new Emitter.Listener() {
        ...
        public void call(Object... args) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(InComingCallActivity.this, "answer call", Toast.LENGTH_SHORT).show();
        ...
        public void call(final Object... args) {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(InComingCallActivity.this, (String)args[0], Toast.LENGTH_SHORT).show();
                }
            });
        }
    };
